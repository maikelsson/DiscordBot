...
namespace DiscordBot.Services
{
    public static class LoggingService
    {
        ...
        public async static Task OnLog(LogMessage msg)
        {
            await LogAsync(msg.Source, msg.Severity, msg.Message);
        }

        //Make this more fancy
        public async static Task WelcomeMessageAsync()
        {
            await Append("\n###This bot is created by Mikael Thornberg 2019###\n\n", ConsoleColor.Green);
        }
    }
}